...
<div class="student-form">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-md-4">
            ...
            <?=$form->field($model,'education')->dropDownList($model->getItemEducation()
            ,[
 ...
 <?= $form->field($model,'school_id')->dropDownList( ArrayHelper::map(\common\models\School::find()->all(),'id','name'),
