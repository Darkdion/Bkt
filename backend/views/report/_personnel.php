    ...
    <div>
        ...
        <table class="table table-bordered" style="font-size:15pt ; ">
            ...
            <tr>
                ...
                <td class="text-center"><strong>ที่อยู่</strong></td>
            ...
            <?php foreach ($model as $models): ?>
                <tr>
                    ...
                    <td><?= $models->address." ต.".$models->districtName." อ.".$models->amphurName." จ.".$models->provinceName ?></td>
