...
<!--        </div>-->
        <div class="text-center">
            <?php ActiveForm::begin([
                'action' => 'paytotall.php?r=dd/index',
                'options' => [
                    'class' => 'form-inline',
                    'name' => 'formProduct'
                ]
...
<div class="table-responsive">
    <div class="x_panel">
        ...
        <?php foreach ($course as $courses): ?>
			...
			<tr>
				<td>
                    <a href="index.php?r=course-register/view&id=<?php echo $courses->id; ?>">
                        <h5><?php echo $courses->cod_id; ?></h5>
                    </a>
                </td>
                <td> <a href="index.php?r=course-register/view&id=<?php echo $courses->id; ?>">
                ...
                <td>
                        ...
                        <a href="index.php?r=course-register/addtocart&id=<?php echo $courses->id; ?>"
