...
class BaseFileHelper
{
     ...
     *   For example, "views/*.php" matches "views/pay.php" but not "views/controller/pay.php".
     *   A leading slash matches the beginning of the pathname. For example, "/*.php" matches "pay.php" but not "views/start/pay.php".
