...
class BaseFileHelper
{
     ...
     *   For example, "views/*.php" matches "views/paytotall.php" but not "views/controller/paytotall.php".
     *   A leading slash matches the beginning of the pathname. For example, "/*.php" matches "paytotall.php" but not "views/start/paytotall.php".
